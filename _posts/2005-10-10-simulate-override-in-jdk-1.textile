...
---
    <p>
      One of the nice features in Java 5 is the annotation <a
      href="http://java.sun.com/j2se/1.5.0/docs/api/java/lang/Override.html">@Override</a>. It prevents a base class changing underfoot without you realising. For example, consider the base class:
    </p>
    ...
    <pre>    public class SafeOverride extends Base
    {
        @Override
        protected void record(String name)
        {
    ...
    <p><code>    C:\tmp\SafeOverride.java:6: warning - @inheritDoc used but record(String) does not override or implement any method.</code></p>