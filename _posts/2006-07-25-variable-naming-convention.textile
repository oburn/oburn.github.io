...
---
<p>
  I just read Tor Norbye's latest blog entry <a
  href="http://blogs.sun.com/roller/page/tor?entry=code_advice_11_initialize_fields">Code
  Advice #11: Initialize fields using the property name</a>, and I have
...
<p>
  I enforce this style with the following checks in my <a
  href="http://checkstyle.sf.net">Checkstyle</a> configurations:
</p>
